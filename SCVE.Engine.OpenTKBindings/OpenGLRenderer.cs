...
namespace SCVE.Engine.OpenTKBindings
{
    public class OpenGLRenderer : IRenderer
    {
        ...
        public void Init()
        {
            ...
            _flatColorShaderProgram = ScveEngine.Instance.Cache.ShaderProgram.LoadOrCache("FlatColor");
            _lineShaderProgram      = ScveEngine.Instance.Cache.ShaderProgram.LoadOrCache("Line");
            _textShaderProgram      = ScveEngine.Instance.Cache.ShaderProgram.LoadOrCache("Text2D");
        }
        ...
        public void SetClipRect(float x, float y, float width, float height)
        {
            ...
            GL.Scissor((int)_clipRect.X, (int)(ScveEngine.Instance.MainWindow.Height - (y + height)), (int)_clipRect.Width, (int)_clipRect.Height);
        }
